...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
      ...
      text.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(text);
      
      JLabel lblid=new JLabel("ID");
      lblid.setBounds(35,80,100,20);
      lblid.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lblid);
      ...
      lblnumber.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lblnumber);
      ...
      lblname.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lblname);
      ...
      lblgender.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lblgender);
      ...
      lblcountry.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lblcountry);
      ...
      lblroom.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lblroom);
      ...
      lbltime.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lbltime);
      ...
      checkintime.setFont(new Font("Ralelway",Font.PLAIN,16));
      add(checkintime);
      
      JLabel lbldeposite=new JLabel("DEPOSITE");
      lbldeposite.setBounds(35,360,100,20);
      lbldeposite.setFont(new Font("Ralelway",Font.PLAIN,20));
      add(lbldeposite);
